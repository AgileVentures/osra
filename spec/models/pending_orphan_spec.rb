...
describe PendingOrphan, type: :model do
  ...
  let(:attributes) { {id: nil, pending_orphan_list_id: nil, name: "الطفل",
    ...
    schooling_status: "الصف الرابع", goes_to_school: true,
    ...
    original_address_neighborhood: "الحي", original_address_street: "الشارع",
    ...
    contact_number: 998716.0, alt_contact_number: "رقم آخر",
