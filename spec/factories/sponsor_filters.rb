    ...
    initialize_with do
      {
        ...
        created_at_from: sponsor.created_at.to_date - 1.day,
        created_at_until: sponsor.created_at.to_date + 1.day,
        updated_at_from: sponsor.updated_at ? sponsor.updated_at.to_date - 1.day : Date.current - 1.day,
        updated_at_until: sponsor.updated_at ? sponsor.updated_at.to_date + 1.day : Date.current + 1.day,
