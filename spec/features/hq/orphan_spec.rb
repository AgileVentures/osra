...
RSpec.feature 'Orphan CRUD spec:', :type => :feature do
  ...
  background do
    i_sign_in_as_admin
    an_orphan_exists 13, "Orphan 1", "Father 1", "2012-01-01", "Male", "Normal"
  ...
  scenario 'There should be a list of orphans on the admin index page' do
    ...
    and_i_should_see_within "Orphan 13", "2012-01-01"
    and_i_should_see_within "Orphan 2", "High"
    and_i_should_see_within "Orphan 13", "Male"
